        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('kondisi.tambah') }}" class="btn btn-primary">+ Tambah Data</a>
                </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('kondisi.edit', $row->id) }}" class="btn btn-warning">Edit</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Apakah anda yakin ingin menghapus kondisi "{{ $row->nama_kondisi }}" ? Data mungkin akan terhapus juga pada bagian mutasi, pemeliharaan dan peminjaman.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">Batal</button>
                                            <form action="{{ route('kondisi.hapus', $row->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
