        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('jenmut.tambah') }}" class="btn btn-primary">+ Tambah Data</a>
                </div>
                <table class="table table-bordered mt-3" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Kode Jenis Mutasi</th>
                            <th>Jenis Mutasi</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('jenmut.edit', $row->id) }}" class="btn btn-warning">Edit</a>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Apakah anda yakin ingin menghapus Jenis Mutasi "{{ $row->jenismutasi }}" ? Data mungkin akan terhapus juga pada bagian mutasi, pemeliharaan dan peminjaman.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">Batal</button>
                                            <form action="{{ route('jenmut.hapus', $row->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
