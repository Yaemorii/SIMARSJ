        ...
        <div class="card-body">
            <div class="table-responsive">
                <div class="d-flex justify-content-end">
                    <a href="{{ route('kategori.tambah') }}" class="btn btn-primary">+ Tambah Data</a>
                </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Apakah anda yakin ingin menghapus kategori "{{ $row->kategori }}" ? Data mungkin akan terhapus juga pada bagian mutasi, pemeliharaan dan peminjaman.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">Batal</button>
                                            <form action="{{ route('kategori.hapus', $row->id) }}" method="POST"
                                                class="d-inline">
                                                @csrf
